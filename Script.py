...
ɪ ᴀᴍ ᴀ ᴘᴏᴡᴇʀꜰᴜʟ ᴀᴜᴛᴏꜰɪʟᴛᴇʀ ʙᴏᴛ. ɪ ᴡɪʟʟ ɢɪᴠᴇ ᴍᴏᴠɪᴇs ᴏʀ sᴇʀɪᴇs ɪɴ ɢʀᴏᴜᴘ ᴀɴᴅ ᴘᴍ !! 😍
<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://t.me/Contact_Vicky_via_bot">Vicky Bots&lt;/&gt;</a></blockquote>"""
...
<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://t.me/Contact_Vicky_via_bot">Vicky Bots&lt;/&gt;</a></b></blockquote>"""

    ABOUT_TEXT = """<blockquote><b>‣ ᴍʏ ɴᴀᴍᴇ : {}
‣ ᴄʀᴇᴀᴛᴏʀ : <a href="https://t.me/Contact_Vicky_via_bot">Vicky Bots&lt;/&gt;</a>
‣ ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ
‣ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ
‣ ᴅᴀᴛᴀ ʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ
‣ ʜᴏsᴛᴇᴅ ᴏɴ  :  ᴡᴇʙ
‣ ʙᴜɪʟᴅ sᴛᴀᴛᴜs : v1.2 [sᴛᴀʙʟᴇ]</b></blockquote>"""
...
If there is an error, ask in the support group @FilmyswapSupport</b>"""
...
"""
    ...
    NO_RESULT_TXT = """<b>ᴍᴏᴠɪᴇ ɴᴏᴛ ꜰᴏᴜɴᴅ ɪɴ ᴅᴀᴛᴀʙᴀꜱᴇ,ᴇɪᴛʜᴇʀ ɪᴛ's ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ / ɴᴏᴛ ʀᴇʟᴇᴀsᴇ / ɴᴏᴛ ᴅᴜʙʙᴇᴅ ʏᴇᴛ...ɪғ ɪᴛ's ᴀᴠᴀɪʟᴀʙʟᴇ ᴛʜᴇɴ ᴅʀᴏᴘ ʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ᴏɴ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ
    ...
    or 
    <b>Send the screenshot of movie from Google</b>"""
...
<code>/font hi how are you</code></b>"""
    ...
    EARN_TEXT= """"Currently this feature is not available."""
...
# <code>/set_verify linkmonetizer.in fcee6bbc628cfc61229a2d808efer0ee3315a0f5e</code>

# <code>/set_verify_2 linkmonetizer.in fcee6bbc62frc61229a2d808e1b0ee3315a0f5e</code>

# <code>/set_verify_3 linkmonetizer.in fcee6bbc628cfc61229agr808e1b0ee3315a0f5e</code>
...
🏆 ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴀ ɴᴇᴡ ᴘʟᴀɴ ᴀᴘᴀʀᴛ ꜰʀᴏᴍ ᴛʜᴇ ɢɪᴠᴇɴ ᴘʟᴀɴ, ᴛʜᴇɴ ʏᴏᴜ ᴄᴀɴ ᴛᴀʟᴋ ᴛᴏ ᴏᴜʀ <a href='https://t.me/Contact_Vicky_via_bot'>ᴏᴡɴᴇʀ</a> ᴅɪʀᴇᴄᴛʟʏ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴏɴ ᴛʜᴇ ᴄᴏɴᴛᴀᴄᴛ ʙᴜᴛᴛᴏɴ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ.
...
🆔 ᴜᴘɪ ɪᴅ ➩ <code>debashis-17@axl</code> [ᴛᴀᴘ ᴛᴏ ᴄᴏᴘʏ]
 
⛽️ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ: /myplan

🏷️ <a href='https://telegram.dog/Contact_Vicky_via_bot'>ᴘʀᴇᴍɪᴜᴍ ᴘʀᴏᴏꜰ</a>
...
--------------Set Ads----------------
➩ /set_ads {ads name}#{Times}#{photo URL} - <a href="https://t.me/Vicky_developer/11">Explain</a>
➩ /del_ads - Delete ads
-------------Top Trending------------
➩ /setlist {Mirzapur, Money Heist} - <a href="https://t.me/Vicky_developer/10">Explain</a>
...
--------------Verify On Off------------
/verifyoff - off verification <a href="https://telegram.dog/Contact_Vicky_via_bot">Cᴏɴᴛᴀᴄᴛ</a> ᴛʜᴇ ʙᴏᴛ ᴀᴅᴍɪɴ ғᴏʀ ᴀ ᴠᴇʀɪғʏ.ᴏғғ
/verifyon - on verification 
------------Set File Caption-----------
/set_caption - set coustom file caption 
-----------Set Imdb Template-----------
/set_template - set IMDb template <a href="https://t.me/FilmyswapSupport/6">Example</a>
--------------Set Tutorial-------------
...
/movie_update_on - Movie Update on</blockquote></b>"""
    ...
    SOURCE_TXT = """<b>
𝐂𝐨𝐧𝐭𝐚𝐜𝐭 𝐀𝐝𝐦𝐢𝐧 𝐅𝐨𝐫 𝐭𝐡𝐞 𝐬𝐨𝐮𝐫𝐜𝐞 𝐜𝐨𝐝𝐞 𝐨𝐫 𝐭𝐨 𝐜𝐫𝐞𝐚𝐭𝐞 𝐲𝐨𝐮𝐫 𝐨𝐰𝐧 𝐁𝐨𝐭. ◉› :<blockquote><a href="https://t.me/Contact_Vicky_via_bot">&lt;Click Here&gt;</a></blockquote>
...
/set_time_3 {seconds} Sᴇᴛ ᴛʜᴇ ᴛʜɪʀᴅ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ ᴛɪᴍᴇ
--------------Verify On Off------------
/verifyoff {verify.off code} - off verification <a href="https://telegram.dog/Contact_Vicky_via_bot">Cᴏɴᴛᴀᴄᴛ</a> ᴛʜᴇ ʙᴏᴛ ᴀᴅᴍɪɴ ғᴏʀ ᴀ ᴠᴇʀɪғʏ.ᴏғғ ᴄᴏᴅᴇ
/verifyon - on verification 
------------Set File Caption-----------
/set_caption - set coustom file caption 
-----------Set Imdb Template-----------
...
Iғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ᴅᴏᴜʙᴛs ᴘʟᴇᴀsᴇ <a href="https://telegram.dog/Contact_Vicky_via_bot">ᴄᴏɴᴛᴀᴄᴛ</a> ᴍe ♡</b>"""
